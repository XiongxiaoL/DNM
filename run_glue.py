...
def main():
    ...
    if data_args.task_name is not None:
        ...
        # datasets = load_dataset("~/.cache/huggingface/datasets/glue", data_args.task_name, cache_dir=model_args.cache_dir)
        # datasets = load_from_disk("~/.cache/huggingface/datasets/glue" + "/" +  data_args.task_name)
    ...
    if data_args.task_name is not None:
        metric = load_metric('./data/glue', data_args.task_name)
